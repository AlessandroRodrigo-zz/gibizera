<%-- 
    Document   : gibi
    Created on : 14/05/2019, 09:52:26
    Author     : Flavio Prado
--%>
        ...
        <header id="header">
            <div class="container">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-active"><a href="#hemo">Início</a></li>                        
                        <li><a href="index.jsp">Voltar <i class="fa-arrow-left"></i></a></li>
                        <li><a href="#contact">Contato</a></li>
                        <li><a href="#home">Pesquisar <i class="fa-search"></i></a></li>
